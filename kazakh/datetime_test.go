...
func TestDatetime(t *testing.T) {
	t.Run("it should be give correct date", func(t *testing.T) {
		...
		t.Run("it should be successfully convert date format", func(t *testing.T) {
			if FormatDatetime(date) != "01.02.2021 03:00:00" {
				t.Fatal("Failed, expect datetime: `01.02.2021 03:00:00`")
			}
		})
	...
	t.Run("it should be successfully add times", func(t *testing.T) {
		...
		t.Run("it should be successfully convert date format", func(t *testing.T) {
			if FormatDatetime(datetime) != "07.02.2021 05:05:00" {
				t.Fatal("Failed, expect datetime: `07.02.2021 05:05:00`")
			}
		})
	})
}
